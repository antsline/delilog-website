---
title: "軽貨物（黒ナンバー）の義務14項目チェックリスト【2026】点呼・点検・記録のやり方と罰則"
description: "黒ナンバー（軽貨物）に課された法令義務14項目を「毎日・定期・緊急」で整理。点呼・日常点検・業務記録の書き方から、記録不備で最大100万円・事業停止の罰則、監査対応の進め方まで、やさしい言葉で完全解説（2026年最新）。"
date: "2026-04-22"
...
![軽貨物（黒ナンバー）の義務14項目チェックリスト【2026】点呼・点検・記録のやり方と罰則](/blog/keikamotsu-anzentaisaku-2025/og.png)
...
詳しい15項目の書き方とPDF雛形（無料DL）は[こちら](/blog/nichijou-tenken-kirokubo-template)で解説しています。
...
> 詳しくは [軽貨物ドライバーの勤務時間ルール完全ガイド｜改善基準告示6つの数値・1人親方の運用・違反時の処分](/blog/kaizen-kijun-kokuji-keikamotsu) を参照してください。
...
**まずは無料でダウンロード。14項目の記録をアプリで**

点呼記録・日常点検（15項目）は**無料プラン**で永続的に使えます。業務の記録・勤務時間管理などのプレミアム機能も14日間無料で試せます。PDFは国交省モデル様式に準拠しているので、運輸支局への提示にもそのまま使えます。
