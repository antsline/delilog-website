...
15項目それぞれの点検手順と書き方は第4章、記録簿への記入サンプルは第5章で解説しています。

印刷せずスマホだけで済ませたい方は、[delilog アプリ（無料）](https://apps.apple.com/jp/app/delilog/id6753698337)なら15項目をチェックするだけで、国交省様式準拠のPDFが自動で出来上がります。
